package me.moderator_man.coffee.impl.gui;
...
public class GuiMods extends GuiScreen
{
    ...
    public void initGui()
    {
        controlList.add(new GuiSmallButton(5, width / 2 - 154, height - 48, "Open mods folder"));
    ...
    protected void actionPerformed(GuiButton guibutton)
    {
        ...
        if(guibutton.id == 5)
        {
            Sys.openURL((new StringBuilder()).append("file://").append(CoffeeLoader.getCoffeeLoader().getModsDirectory()).toString());
        }
        if(guibutton.id == 6)
        {
    ...
    public void drawScreen(int i, int j, float f)
    {
        ...
        ArrayList<TexturePackBase> list = new ArrayList<TexturePackBase>();
        for (ICoffeeMod mod : CoffeeLoader.getCoffeeLoader().getModManager().getAllMods())
    		list.add(new ModListEntry(mod));
        ...
        GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/ /*GL_TEXTURE_2D*/, mc.renderEngine.getTexture("/gui/background.png"));
        ...
        drawCenteredString(fontRenderer, "Installed Mods", width / 2, 16, 0xffffff);
