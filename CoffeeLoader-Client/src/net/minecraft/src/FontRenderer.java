...
public class FontRenderer
{
    ...
    public FontRenderer(GameSettings gamesettings, String s, RenderEngine renderengine)
    {
        ...
        field_1308_a = 0;
        buffer = GLAllocation.createDirectIntBuffer(1024 /*GL_FRONT_LEFT*/ /*GL_FRONT_LEFT*/);
        ...
        {
            GL11.glNewList(field_1310_c + i1, 4864 /*GL_COMPILE*/ /*GL_COMPILE*/);
        ...
        for(int j1 = 0; j1 < 32; j1++)
        {
            ...
            GL11.glNewList(field_1310_c + 256 + j1, 4864 /*GL_COMPILE*/ /*GL_COMPILE*/);
