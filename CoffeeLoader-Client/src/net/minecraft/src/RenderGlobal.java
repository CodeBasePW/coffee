    ...
    implements IWorldAccess
{
    ...
    public RenderGlobal(Minecraft minecraft, RenderEngine renderengine)
    {
        ...
        GL11.glPushMatrix();
        GL11.glNewList(field_1434_y, 4864 /*GL_COMPILE*/ /*GL_COMPILE*/);
        func_950_f();
        GL11.glEndList();
        GL11.glPopMatrix();
        Tessellator tessellator = Tessellator.instance;
        field_1433_z = field_1434_y + 1;
        GL11.glNewList(field_1433_z, 4864 /*GL_COMPILE*/ /*GL_COMPILE*/);
        byte byte1 = 64;
        int i = 256 / byte1 + 2;
        float f = 16F;
        ...
        GL11.glNewList(field_1432_A, 4864 /*GL_COMPILE*/ /*GL_COMPILE*/);
        f = -16F;
        tessellator.startDrawingQuads();
    ...
    public int func_943_a(EntityPlayer entityplayer, int i, double d)
    {
        ...
        if(field_1436_w && !mc.gameSettings.anaglyph && i == 0)
        {
            ...
            do
            {
                ...
                GL11.glDisable(3553 /*GL_TEXTURE_2D*/ /*GL_TEXTURE_2D*/);
                GL11.glDisable(2896 /*GL_LIGHTING*/ /*GL_LIGHTING*/);
                GL11.glDisable(3008 /*GL_ALPHA_TEST*/ /*GL_ALPHA_TEST*/);
                GL11.glDisable(2912 /*GL_FOG*/ /*GL_FOG*/);
                ...
                for(int j1 = byte0; j1 < l; j1++)
                {
                    ...
                    ARBOcclusionQuery.glBeginQueryARB(35092 /*GL_SAMPLES_PASSED_ARB*/ /*GL_SAMPLES_PASSED_ARB*/, field_1445_n[j1].field_1732_z);
                    field_1445_n[j1].func_1201_d();
                    ARBOcclusionQuery.glEndQueryARB(35092 /*GL_SAMPLES_PASSED_ARB*/ /*GL_SAMPLES_PASSED_ARB*/);
                ...
                GL11.glEnable(3553 /*GL_TEXTURE_2D*/ /*GL_TEXTURE_2D*/);
                GL11.glEnable(3008 /*GL_ALPHA_TEST*/ /*GL_ALPHA_TEST*/);
                GL11.glEnable(2912 /*GL_FOG*/ /*GL_FOG*/);
    ...
    private void func_962_a(int i, int j)
    {
        for(int k = i; k < j; k++)
        {
            ...
            field_1456_c.clear();
            ARBOcclusionQuery.glGetQueryObjectuARB(field_1445_n[k].field_1732_z, 34919 /*GL_QUERY_RESULT_AVAILABLE_ARB*/ /*GL_QUERY_RESULT_AVAILABLE_ARB*/, field_1456_c);
            if(field_1456_c.get(0) != 0)
            {
                field_1445_n[k].field_1733_y = false;
                field_1456_c.clear();
                ARBOcclusionQuery.glGetQueryObjectuARB(field_1445_n[k].field_1732_z, 34918 /*GL_QUERY_RESULT_ARB*/ /*GL_QUERY_RESULT_ARB*/, field_1456_c);
    ...
    public void func_4142_a(float f)
    {
        ...
        {
            GL11.glDisable(3553 /*GL_TEXTURE_2D*/ /*GL_TEXTURE_2D*/);
            GL11.glShadeModel(7425 /*GL_SMOOTH*/ /*GL_SMOOTH*/);
            GL11.glPushMatrix();
            ...
            tessellator.draw();
            GL11.glPopMatrix();
            GL11.glShadeModel(7424 /*GL_FLAT*/ /*GL_FLAT*/);
        }
        GL11.glEnable(3553 /*GL_TEXTURE_2D*/ /*GL_TEXTURE_2D*/);
        ...
        float f11 = 30F;
        GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/ /*GL_TEXTURE_2D*/, renderEngine.getTexture("/terrain/sun.png"));
        tessellator.startDrawingQuads();
        ...
        tessellator.draw();
        f11 = 20F;
        GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/ /*GL_TEXTURE_2D*/, renderEngine.getTexture("/terrain/moon.png"));
        tessellator.startDrawingQuads();
        tessellator.addVertexWithUV(-f11, -100D, f11, 1.0D, 1.0D);
        tessellator.addVertexWithUV(f11, -100D, f11, 0.0D, 1.0D);
        tessellator.addVertexWithUV(f11, -100D, -f11, 0.0D, 0.0D);
    ...
    public void func_4141_b(float f)
    {
        ...
        GL11.glDisable(2884 /*GL_CULL_FACE*/ /*GL_CULL_FACE*/);
        float f1 = (float)(mc.thePlayer.lastTickPosY + (mc.thePlayer.posY - mc.thePlayer.lastTickPosY) * (double)f);
        byte byte0 = 32;
        int i = 256 / byte0;
        Tessellator tessellator = Tessellator.instance;
        GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/ /*GL_TEXTURE_2D*/, renderEngine.getTexture("/environment/clouds.png"));
        GL11.glEnable(3042 /*GL_BLEND*/ /*GL_BLEND*/);
        GL11.glBlendFunc(770, 771);
        ...
        d -= j * 2048 /*GL_EXP*/ /*GL_EXP*/;
        d1 -= k * 2048 /*GL_EXP*/ /*GL_EXP*/;
        ...
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        GL11.glDisable(3042 /*GL_BLEND*/ /*GL_BLEND*/);
        GL11.glEnable(2884 /*GL_CULL_FACE*/ /*GL_CULL_FACE*/);
    }
    ...
    public void func_6510_c(float f)
    {
        ...
        d -= i * 2048 /*GL_EXP*/ /*GL_EXP*/;
        d1 -= j * 2048 /*GL_EXP*/ /*GL_EXP*/;
        GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/ /*GL_TEXTURE_2D*/, renderEngine.getTexture("/environment/clouds.png"));
        GL11.glEnable(3042 /*GL_BLEND*/ /*GL_BLEND*/);
        GL11.glBlendFunc(770, 771);
        Vec3D vec3d = worldObj.func_628_d(f);
    ...
    public void func_959_a(EntityPlayer entityplayer, MovingObjectPosition movingobjectposition, int i, ItemStack itemstack, float f)
    {
        ...
        if(i == 0)
        {
            if(field_1450_i > 0.0F)
            {
                ...
                GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/ /*GL_TEXTURE_2D*/, j);
                ...
                GL11.glEnable(32823 /*GL_POLYGON_OFFSET_FILL*/ /*GL_POLYGON_OFFSET_FILL*/);
                tessellator.startDrawingQuads();
                ...
                GL11.glDisable(32823 /*GL_POLYGON_OFFSET_FILL*/ /*GL_POLYGON_OFFSET_FILL*/);
                GL11.glEnable(3008 /*GL_ALPHA_TEST*/ /*GL_ALPHA_TEST*/);
                GL11.glDepthMask(true);
                GL11.glPopMatrix();
            }
        ...
        if(itemstack != null)
        {
            ...
            GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/ /*GL_TEXTURE_2D*/, l);
