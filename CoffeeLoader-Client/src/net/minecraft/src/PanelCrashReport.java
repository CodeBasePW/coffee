...
public class PanelCrashReport extends Panel
{
    ...
    public PanelCrashReport(UnexpectedThrowable unexpectedthrowable)
    {
        ...
        try
        {
            ...
            s1 = GL11.glGetString(7936 /*GL_VENDOR*/ /*GL_VENDOR*/);
            s2 = (new StringBuilder()).append(s2).append("OpenGL: ").append(GL11.glGetString(7937 /*GL_RENDERER*/ /*GL_RENDERER*/)).append(" version ").append(GL11.glGetString(7938 /*GL_VERSION*/ /*GL_VERSION*/)).append(", ").append(GL11.glGetString(7936 /*GL_VENDOR*/ /*GL_VENDOR*/)).append("\n").toString();
        }
