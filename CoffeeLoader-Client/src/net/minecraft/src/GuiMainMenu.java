...
public class GuiMainMenu extends GuiScreen
{
    ...
    public GuiMainMenu()
    {
        ...
        try
        {
            ...
            //TODO: moderator_man
            splashText = "CoffeeLoader v" + CoffeeLoader.getCoffeeLoader().getVersion();
        }
    ...
    public void drawScreen(int i, int j, float f)
    {
        ...
        drawLogo(f);
        GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/ /*GL_TEXTURE_2D*/, mc.renderEngine.getTexture("/gui/logo.png"));
    ...
    private void drawLogo(float f)
    {
        ...
        GL11.glMatrixMode(5889 /*GL_PROJECTION*/ /*GL_PROJECTION*/);
        GL11.glPushMatrix();
        GL11.glLoadIdentity();
        ...
        GL11.glMatrixMode(5888 /*GL_MODELVIEW0_ARB*/ /*GL_MODELVIEW0_ARB*/);
        GL11.glPushMatrix();
        GL11.glLoadIdentity();
        GL11.glDisable(2884 /*GL_CULL_FACE*/ /*GL_CULL_FACE*/);
        GL11.glCullFace(1029 /*GL_BACK*/ /*GL_BACK*/);
        ...
        for(int l = 0; l < 3; l++)
        {
            ...
            if(l == 0)
            {
                GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/ /*GL_TEXTURE_2D*/, mc.renderEngine.getTexture("/title/black.png"));
            }
