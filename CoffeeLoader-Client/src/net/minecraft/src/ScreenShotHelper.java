...
public class ScreenShotHelper
{
    ...
    public static String func_4148_a(File file, int i, int j)
    {
        try
        {
            ...
            GL11.glPixelStorei(3333 /*GL_PACK_ALIGNMENT*/ /*GL_PACK_ALIGNMENT*/, 1);
            GL11.glPixelStorei(3317 /*GL_UNPACK_ALIGNMENT*/ /*GL_UNPACK_ALIGNMENT*/, 1);
            field_4286_b.clear();
            GL11.glReadPixels(0, 0, i, j, 6407 /*GL_RGB*/ /*GL_RGB*/, 5121 /*GL_UNSIGNED_BYTE*/ /*GL_UNSIGNED_BYTE*/, field_4286_b);
            field_4286_b.clear();
