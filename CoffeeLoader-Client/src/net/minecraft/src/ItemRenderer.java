...
public class ItemRenderer
{
    ...
    public void renderItemInFirstPerson(float f)
    {
        ...
        } else
        {
            ...
            GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/ /*GL_TEXTURE_2D*/, mc.renderEngine.getTextureForDownloadableImage(mc.thePlayer.skinUrl, mc.thePlayer.getEntityTexture()));
    ...
    public void renderOverlays(float f)
    {
        ...
        if(mc.thePlayer.func_345_I())
        {
            ...
            GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/ /*GL_TEXTURE_2D*/, j1);
        ...
        if(mc.thePlayer.isInsideOfMaterial(Material.water))
        {
            ...
            GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/ /*GL_TEXTURE_2D*/, k);
